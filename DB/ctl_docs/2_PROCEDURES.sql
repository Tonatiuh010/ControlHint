...
-- CALL SET_DOCS_APPROVER (1,1,1,"NOSE", "SEPA", 1, "MIPOYA", @OUT_MSG);
...
BEGIN
	...
	IF ROW_COUNT() = 0 THEN
        ...
        VALUES (IN_FILE_ID, IN_DOCUMENT_ID, UNHEX(IN_DOC_IMG), IN_USER);
	END IF;
END ;
// DELIMITER ;
...
END
// DELIMITER ;
-- CALL SET_DOCS_FLOW (1,1,"KEY1","KEY2","KEY3","KEY4", "USER1", @OUT_MSG);
