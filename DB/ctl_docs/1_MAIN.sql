DROP DATABASE IF EXISTS CTL_DOCS;
...
DROP TABLE IF EXISTS DOC_APPROVER CASCADE;
...
CREATE TABLE DOC_FILE(
    ...
    DOCUMENT_OBJ LONGTEXT,
    DOC_IMG LONGBLOB
);

CREATE TABLE DOC_TXN (
	DOCUMENT_ID INT NOT NULL,
    APPROVER_ID INT NOT NULL,
    DOC_APPROVER_ID INT NOT NULL,
    COMMENTS VARCHAR(450),
    STATUS_TXN VARCHAR(450) NOT NULL    
);

ALTER TABLE DOC_APPROVER
ADD CONSTRAINT FK_DOC_FLOW_ID
...
ALTER TABLE DOC_TXN ADD CONSTRAINT PK_TXN_DOC PRIMARY KEY (DOCUMENT_ID, APPROVER_ID),
					 ADD CONSTRAINT FK_TXN_APPROVER FOREIGN KEY (APPROVER_ID) REFERENCES APPROVER (APPROVER_ID),
                    ADD CONSTRAINT FK_TXN_DOC_APP FOREIGN KEY (DOC_APPROVER_ID) REFERENCES DOC_APPROVER (DOC_APPROVER_ID);
