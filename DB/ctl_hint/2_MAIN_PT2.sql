...
ALTER TABLE DEV_HINT_CONFIG ADD CONSTRAINT PK_DEV_HINT_CONFIG PRIMARY KEY(DEVICE_ID, HINT_KEY_ID),
...
ALTER TABLE USR_ACCESS ADD CONSTRAINT UQ_USER_NAME UNIQUE (USER_NAME);
